using _998Intergration.Helper;
using Newtonsoft.Json;
using System;
using System.Threading.Tasks;
using static _998Intergration.Models.Models_Request;
using static _998Intergration.Models.Models_Reponse;


namespace _998Intergration
{
    public class Intergration
    {
        ...
        //998 API List Start//
        public static async Task<Login_Response> CreateNewPlayer(string strPlayerUserName, string strPlayerFullName, string strPlayerEmail, string strPlayerPhone, string strPlayerDOB, string strPlayerPassword, string Country, int Gender)
        {
            try
            {
                //PREPARE URL
                ...
                var requestbody = new Models_Register_Player()
                {
                    Partner = PartnerName,
        ...
        public static async Task<Deposit_Response> TransferGameCredit(string strUserName, decimal dcTransferAmount, string strTransactionID)
        {
            //PREPARE URL
            string API_PATH = "deposit";
            int TimeStamp = (int)(DateTime.UtcNow.Subtract(new DateTime(1970, 1, 1))).TotalSeconds;
            var requestbody = new Models_Player_TransferCredit()
            {
                Partner = PartnerName,
                Sign = HttpService.CreateSignature(PartnerName, TimeStamp, PatnerKey),
                TimeStamp = TimeStamp,
        ...
        public static async Task<Withdraw_Response> WithdrawGameCredit(string strUserName, decimal dcTWithdrawAmount, string strTransactionID)
        {
            //PREPARE URL
            string API_PATH = "withdrawal";
            int TimeStamp = (int)(DateTime.UtcNow.Subtract(new DateTime(1970, 1, 1))).TotalSeconds;
            var requestbody = new Models_Player_WithdrawCredit()
            {
                Partner = PartnerName,
                Sign = HttpService.CreateSignature(PartnerName, TimeStamp, PatnerKey),
                TimeStamp = TimeStamp,
        ...
        public static async Task<Balance_Response> GetBalance(string strUserName)
        {
            ...
            try
            {
                ...
                var requestbody = new Models_Retrieve_Balance_Player()
                {
                    Partner = PartnerName,
        ...
        public static async Task<CheckTransaction_Response> CheckTransactionStatus(string strTransactionID)
        {

            //PREPARE URL
            string API_PATH = "check";
            int TimeStamp = (int)(DateTime.UtcNow.Subtract(new DateTime(1970, 1, 1))).TotalSeconds;
            var requestbody = new Models_Player_CheckTransaction
            {
                Partner = PartnerName,
                Sign = HttpService.CreateSignature(PartnerName, TimeStamp, PatnerKey),
                TimeStamp = TimeStamp,
        ...
        public static async Task<Login_Response> RetrievePlayerToken(string strUserName)
        {
            try
            {
                //PREPARE URL
                ...
                var requestbody = new Models_Login_Player()
                {
                    Partner = PartnerName,
        ...
        public static async Task<Open_Game_Response> OpenGame(string token, string gameVendor, string language, string browser, string gameCode)
        {
            try
            {
                //PREPARE URL
                ...
                var requestbody = new Models_Player_PlayGame()
                {
                   Vendor = gameVendor,
                   Browser= browser,
                   Lang = language,
        ...
        public static async Task<Game_List_Response> GameList(string token, string gameVendor)
        {
            try
            {
                //PREPARE URL
        ...
        public static async Task<GetTicket_Fetch_Response> GetTicketsByFetch(string strStartTime, string strEndTime)
        {
            try
            {
                //PREPARE URL
                ...
                var requestbody = new Models_Player_GetTickets_Fetch()
                {
                    Partner = PartnerName,
                    Sign = HttpService.CreateSignature(PartnerName, TimeStamp, PatnerKey),
                    TimeStamp = TimeStamp,
        ...
        public static async Task<GetTicket_Response> GetTicket(string strVendorCode, string strUsername, string strStartTime, string strEndTime)
        {
            try
            {
                //PREPARE URL
                ...
                var requestbody = new Models_Player_GetTickets()
                {
                    Partner = PartnerName,
                    Sign = HttpService.CreateSignature(PartnerName, TimeStamp, PatnerKey),
                    TimeStamp = TimeStamp,
        ...
        public static async Task<GetWinLoss_Response> GetWinLoss(int intProductcode, string strUsername, string strStatementDate)
        {
            ...
            try
            {
                ...
                var requestbody = new Models_Player_GetWinLoss()
                {
                    Partner = PartnerName,
                    Sign = HttpService.CreateSignature(PartnerName, TimeStamp, PatnerKey),
                    TimeStamp = TimeStamp,
